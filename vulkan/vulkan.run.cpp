...
)
{
    ...
    while (running)
    {
        ...
        {
            std::string recreate_output = recreate_vulkan_swapchain(logical_device.get(), vulkan_surface.get(), physical_device, surface_format, present_mode, graphics_family_index, present_family_index, render_pass.get(), window, swapchain, swapchain_images_views, framebuffers, extent, semaphores, image_available_semaphores, render_finished_semaphores);
